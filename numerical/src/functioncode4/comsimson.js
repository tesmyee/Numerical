...
function Comsimson() {
    ...
    function calsimson() {
        ...
        while ((a + (h * i)) <= b) {
            if ((a + (h * i)) === a || (a + (h * i)) === b) {
                xa = xa + ans(fn, (a + (h * i)))
                console.log('xa: ' + xa + ' i:' + i)
            }
            else if (i % 2 === 0) {
                x2a = x2a + ans(fn, (a + (h * i)))
                console.log('x2a: ' + x2a + ' i:' + i)
            }
            else if (i%2===1){
                x1a = x1a + ans(fn, (a + (h * i)))
                console.log('x1a: ' + x1a + 'i: ' + i)
            }
            i++
        }
        x2a = x2a * 2
    ...
    return (
        <Content>
            <Layout style={{ margin: '70px', padding: '10px 10px' }}>
                <h1 style={{ color: 'green' }}>COMPOSITE SIMSON</h1>
            </Layout>
            <Layout style={{
                margin: '70px',
                padding: '40px 40px',
